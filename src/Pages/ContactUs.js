    ...
    return (
        <div>
            ...
            <div className='flex justify-center items-center mt-[-2rem]'>
                <div className='w-[80%] shadow-xl bg-white p-8 flex flex-row gap-4 text-center text-base'>
                    <div className='border-[#DEDEDE] rounded-md flex flex-col justify-center items-center p-4 w-1/3'
