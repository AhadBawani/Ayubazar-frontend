...
const UserReducer = (state = userState, { type, payload }) => {
    switch (type) {
        ...
        case ActionType.CODCHARGES:
            return { ...state, codCharges: payload };

        case ActionType.CODAVAILABLE:
            return { ...state, codAvailable: payload };
        ...
        case ActionType.HANDLINGCHARGES:
            return { ...state, handlingCharges: payload };

        case ActionType.VALIDATEFORM:
            return { ...state, validateForm: payload };
