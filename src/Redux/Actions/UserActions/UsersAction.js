...
export const TotalAction = (response, position) => {
    return {
...
export const UserOrdersAction = (response) => {
    return {
        type: ActionType.USERORDERS,
        payload: response
    }
}

export const ShowOrderAction = (response) => {
    return {
        type: ActionType.SHOWORDER,
        payload: response
    }
}

export const CodChargesAction = (response) => {
    return {
        type: ActionType.CODCHARGES,
        payload: response
    }
}

export const CodAvailableAction = (response) => {
    return {
        type: ActionType.CODAVAILABLE,
        payload: response
    }
}

export const HandlingChargesAction = (response) => {
    return {
        type: ActionType.HANDLINGCHARGES,
        payload: response
    }
}

export const ValidateFormAction = (response) => {
    return {
