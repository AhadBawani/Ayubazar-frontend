...
import { downloadOrderInvoiceHandler } from '../../RequestHandlers/RequestHandler/UserRequestHandler';
...
const Orders = () => {
    ...
    const handleInvoiceDownload = async (orderData) => {
        try {
            await downloadOrderInvoiceHandler(orderData?.orderId, orderData?.userId);
