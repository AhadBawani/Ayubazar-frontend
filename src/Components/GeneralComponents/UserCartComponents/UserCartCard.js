    ...
    useEffect(() => {
        if (!productPrice) {
            if (item?.product?.discount) {
                const discountAmt = (Object.values(item?.option) * (item?.product?.discount) / 100);
                setProductPrice(Math.floor(Object.values(item?.option) - discountAmt));
            }
            else {
                setProductPrice(Object.values(item?.option));
            }
        }
    }, [item, productPrice])
            ...
            <div className='mb-6 relative'>
                    ...
                    <div className='ml-2 flex flex-col flex-grow'>
                        <div style={{ maxWidth: '240px' }} className="whitespace-normal">
                            <span
                             ...
                             text-[#333] text-base hover:text-[#d0bdac] font-semibold cursor-pointer'
                        ...
                        <div className='flex mt-auto'>
                            ...
                            hover:text-[#d0bdac] hover:bg-[#f1f1f1]'
                                ...
                                onClick={() => handleSubtractQuantity(item?.quantity)}>
                ...
                <div className='absolute bottom-0 right-0'>
                    <div className='flex justify-center items-center'>
                        <div className='flex'>
                            <LuIndianRupee className='mt-1' />
                            <span>{parseInt(item?.quantity) * productPrice}</span>
                        </div>
                    </div>
                </div>
            </div>
