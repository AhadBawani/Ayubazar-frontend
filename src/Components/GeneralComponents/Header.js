...
import { AuthenticateDialogAction, MyAccountOptionAction, OpenCartAction, UserMenuAction } from '../../Redux/Actions/ComponentActions/ComponentActions';
...
const Header = () => {
    ...
    const { mobile, myAccountOption } = useComponentState();
                    ...
                    <>
                        <div className='m-2 p-2 flex items-center max-w-sm'>
                            ...
                            <div className='flex justify-start'>
                                {
                                    pathname === '/my-account' &&
                                        (myAccountOption === 'Orders' |
                                            myAccountOption === 'Account-details' |
                                            myAccountOption === 'Addresses')
                                        ?
                                        <>
                                            <IoMdArrowRoundBack
