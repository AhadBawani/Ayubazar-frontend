        ...
        <>
            {
                ...
                text-white rounded-full h-[17px] w-[17px] flex items-center justify-center'
                    ...
                    :
                    <>
                        <div className='w-full p-1 h-[40px] text-white bg-[#074900] overflow-hidden relative'>
                            <div className="marquee animate-marquee">
                                <span className="mr-6">We are proud to offer our shipping services to over 180+ countries worldwide</span>
                                <span className="mr-6">Any issues, please let us know. We are available on WhatsApp at +91 94 285 60666</span>
                            </div>
                        </div>
