                        ...
                        user
                            ...
                            <>
                                {
                                    ...
                                    <>
                                        <div className='flex flex-col'>
                                            <span style={{ lineHeight: '1.6' }} className='text-[#888] font-bold'>Welcome</span>
                                            <span style={{ lineHeight: '1.6' }} className='mt-1 font-bold'>{user?.displayName}</span>
                                        </div>
                                        <hr className='my-4' />
                                    </>
                                }
                                <div className='flex flex-col'>
                                    {
                                        options.map((item, index) => {
                                            return <>
                                                <div key={index} className='flex text-[#999] mb-3'
                            ...
                            <>
                                <div className='flex flex-col justify-center items-center mt-6'>
                                    <span className='text-xl font-bold mb-2'>Good to see you here!</span>
                                    <button
                                        style={{
                                            letterSpacing: '2px',
                                            lineHeight: '1.4',
