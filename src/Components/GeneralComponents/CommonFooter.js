...
const CommonFooter = () => {
    ...
    return (
        <div className='bg-[#084701] w-full' style={{ borderTop: '1px solid #ececec' }}>
            <div className='flex flex-col sm:flex-row sm:justify-between space-y-4 sm:space-x-4 m-4 p-4'>
                {
                    options.map((item, index) => {
                        return <div className='bg-[#256E1D] transition-all ease-in-out duration-200
                        rounded text-center p-4 w-full md:w-1/4 h-[150px] cursor-pointer' key={index}>
