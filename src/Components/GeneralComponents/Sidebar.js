  ...
  return (
    <>
      <div ref={wrapperRef} className={cart ?
        'fixed top-0 right-0 w-[90%] sm:w-[410px] h-screen bg-white z-10 transform translate-x-0 transition-all' :
        'fixed top-0 left-0 w-[90%] sm:w-[410px] h-screen bg-white z-10 transform translate-x-full transition-all'}>
