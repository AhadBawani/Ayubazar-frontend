...
const OrderDetail = () => {
    ...
    return (
        <div className='p-4 pt-4 sm:px-[70px] sm:pt-[65px] w-full text-[15px] text-[#333]'>
            <div>
                    ...
                    {showApplyCoupon && (
                        <div className="transition-all ease-in-out duration-500 my-5">
                            ...
                            <div className='flex'>
                                ...
                                ease-in-out duration-200 text-white bg-[#256E1D] hover:bg-[#084701]'
                ...
                <div className='flex text-[#d0bdac]'>
                    <span><LuIndianRupee className='mt-[4px] mr-[1px]' /></span>
                    {
                        handlingCharges > 0
                            ?
                            <>
                                <span>{parseInt(total) + parseInt(handlingCharges)}.00</span>
                            </>
                            :
                            <>
                                <span>{total}.00</span>
