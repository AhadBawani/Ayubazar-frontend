...
const ProductDetail = ({ product, dispatch }) => {
    ...
    useEffect(() => {
        if (product?.isVariationAvailable && JSON.parse(product?.options)?.length > 0) {
    ...
    const handleBuyNow = () => {
        if (!selectedOption & product?.isVariationAvailable) {
            toast.error('Please select any options');
            return;
        }
        if (user) {
                ...
                <span className='flex mt-4'
                    ...
                    }}>
                    {
                        product?.isVariationAvailable
                            ...
                            :
                            <>
                                <LuIndianRupee className='mt-1' /> {product?.salesPrice}.00
                            </>
                    }
                </span>
            </div>
                ...
                <div className='flex mt-2'>
                    ...
                    <div className='w-2/4 ml-2'>
                        <button
                            ...
                            ${!selectedOption & product?.isVariationAvailable && 'cursor-not-allowed'}
